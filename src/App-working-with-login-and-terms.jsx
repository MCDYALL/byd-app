...
const [acceptedTerms, setAcceptedTerms] = useState(false);
  ...
  const selectedCarImage =
    CAR_COLOURS.find((item) => item.key === selectedColour)?.image ||
    "/car-default.png";
  ...
  return (
    <div style={{ padding: 40 }}>
      <h2>Login</h2>
      <button onClick={() => setAppStep("disclaimer")}>
        Enter App
      </button>
    </div>
  );
}
if (appStep === "disclaimer") {
  return (
    <div style={{ padding: 20, height: "100vh", overflowY: "auto" }}>
      ...
      <p>
        ...
        Actual results may differ significantly due to real-world factors.
        Do not rely solely on this app for planning or safety decisions.
      </p>

      <p>
        By using this App, you accept full responsibility and agree that the developer
        is not liable for any outcomes resulting from its use.
      </p>
        ...
        <div style={{ padding: 18 }}>
          ...
          {tab === "trip" && (
            <div style={{ display: "grid", gap: 14 }}>
              ...
              {!hasEnoughBatteryForTrip && (
                <WarningCard text="Warning: Current battery is not sufficient for this trip while keeping your safety buffer. Please charge the vehicle first or reduce the planned trip distance." />
              )}
          ...
          {tab === "charge" && (
            <div style={{ display: "grid", gap: 14 }}>
              <SectionCard
                ...
                subtitle="Charge start and target now default from your trip plan, but can still be adjusted."
              >
                <div
                  style={{
                    display: "grid",
          ...
          {tab === "specs" && (
            <div style={{ display: "grid", gap: 14 }}>
              ...
              <InfoRow
                label="Efficiency"
                value={`${efficiency.toFixed(1)} kWh/100km`}
              />
              <InfoRow
                label="Safety buffer"
